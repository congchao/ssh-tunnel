...
Add-EnvFlag -Name "CFLAGS" -Flag "/FIstdlib.h"
Add-EnvFlag -Name "CFLAGS_x86_64_pc_windows_msvc" -Flag "/FIstdlib.h"
Add-EnvFlag -Name "CFLAGS" -Flag "/D__builtin_bswap16=_byteswap_ushort"
Add-EnvFlag -Name "CFLAGS_x86_64_pc_windows_msvc" -Flag "/D__builtin_bswap16=_byteswap_ushort"
Add-EnvFlag -Name "CFLAGS" -Flag "/D__builtin_bswap32=_byteswap_ulong"
Add-EnvFlag -Name "CFLAGS_x86_64_pc_windows_msvc" -Flag "/D__builtin_bswap32=_byteswap_ulong"
Add-EnvFlag -Name "CFLAGS" -Flag "/D__builtin_bswap64=_byteswap_uint64"
Add-EnvFlag -Name "CFLAGS_x86_64_pc_windows_msvc" -Flag "/D__builtin_bswap64=_byteswap_uint64"
